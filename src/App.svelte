<script>
  ...
  let name = "Katelyn"; // Change this to your name
  let favoriteNumber = 8; // Change this to your favorite number
  let bio = "I am a web developer with a passion for building cool things!";
  let hobbies = ["Coding", "Reading", "Traveling", "Learning French","Hiking","Swimming", "Journaling"]; // List some hobbies
